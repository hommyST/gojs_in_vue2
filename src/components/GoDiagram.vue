  ...
  methods: {
    init() {
      ...
      this.myDiagram = new go.Diagram("myDiagramDiv", {
        ...
        // commandHandler: go.DrawCommandHandler,  // support offset copy-and-paste
      ...
      function makeArrowButton(spot, fig) {
        ...
        return $(go.Shape, {
          ...
          width:
            spot.equals(go.Spot.Top) || spot.equals(go.Spot.Bottom) ? 25 : 18,
          height:
            spot.equals(go.Spot.Top) || spot.equals(go.Spot.Bottom) ? 18 : 25,
          fill: "orange",
          stroke: colors.white,
          strokeWidth: 4,
      ...
      // this.myDiagram.groupTemplate.selectionAdornmentTemplate =
      //   $(go.Adornment, "Spot",
      //     $(go.Panel, "Auto",
      ...
      // this.myDiagram.groupTemplate.contextMenu =
      //   $("ContextMenu",
      //     LightFillButtons(),
      //     DarkColorButtons(),
      //     StrokeOptionsButtons()
      ...
      this.myDiagram.linkTemplate.selectionAdornmentTemplate = $(
      ...
      this.myDiagram.linkTemplate.contextMenu = $(
        "ContextMenu",
        DarkColorButtons(),
        StrokeOptionsButtons(),
        $(
